...
describe Graph::Person, :neo4j, :quiet do
  ...
  describe ".index_marriages()" do
    ...
    it "creates nodes and relationships for marriages" do
      ...
      create(:person_event_rel, person: p1, event: e)
      create(:person_event_rel, person: p2, event: e)
    ...
    it "skips events with more than / fewer than 2 people" do
      ...
      create(:person_event_rel, person: p3, event: e2)
  ...
  describe ".index_births()" do
    ...
    it "links mother, father, and child" do
      ...
      create(:person_event_rel, person: m, event: e, event_role: @mother)
      create(:person_event_rel, person: f, event: e, event_role: @father)
      create(:person_event_rel, person: c, event: e, event_role: @child)
