  ...
  describe "GET #index" do
    ...
    describe "people" do
      ...
      before do
        ...
        create(:person_event_link, person: @p2, event: @e3)
        create(:person_event_link, person: @p2, event: @e4)
        create(:person_event_link, person: @p3, event: @e5)
        create(:person_event_link, person: @p3, event: @e6)
    ...
    describe "occupations" do
      ...
      before do
        ...
        create(:person_occupation_link, person: @p1, occupation: @o1)
        create(:person_occupation_link, person: @p2, occupation: @o2)
        create(:person_occupation_link, person: @p3, occupation: @o3)
    ...
    it "source+steps", :neo4j, :quiet do
      ...
      create(:person_event_link, person: p3, event: e3)
      create(:person_event_link, person: p4, event: e4)
      create(:person_event_link, person: p5, event: e5)
